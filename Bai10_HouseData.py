...
# Load dữ liệu
data = pd.read_csv(r"E:\Data\DeCuongOnTap\ChuyenDeTienTien\Bai10_HouseData\kc_house_data.csv")
...
writeFile(r"E:\Data\DeCuongOnTap\ChuyenDeTienTien\Bai10_HouseData\ketqua.txt", result)
