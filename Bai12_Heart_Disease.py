...
# Load dữ liệu
data = pd.read_csv(r"E:\Data\DeCuongOnTap\ChuyenDeTienTien\Bai12_Heart Disease\Cleveland_hd.csv")
...
writeFile(r"E:\Data\DeCuongOnTap\ChuyenDeTienTien\Bai12_Heart Disease\ketqua.txt", result)
