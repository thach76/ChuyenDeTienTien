...
# Load dữ liệu
data = pd.read_csv(r"E:\Data\DeCuongOnTap\ChuyenDeTienTien\Bai13_Heart failure clinical records Data Set\heart_failure_clinical_records_dataset.csv")
...
writeFile(r"E:\Data\DeCuongOnTap\ChuyenDeTienTien\Bai13_Heart failure clinical records Data Set\ketqua.txt", result)
