...
# Load dữ liệu
data = pd.read_csv(r"E:\Data\DeCuongOnTap\ChuyenDeTienTien\Bai14_House\Houses.csv", encoding='iso-8859-2')
...
writeFile(r"E:\Data\DeCuongOnTap\ChuyenDeTienTien\Bai14_House\ketqua.txt", result)
