...
# Load dữ liệu
data = pd.read_csv(r"E:\Data\DeCuongOnTap\ChuyenDeTienTien\Bai1_bank_loan\Bank_Personal_Loan_Modelling.csv")
...
writeFile(r"E:\Data\DeCuongOnTap\ChuyenDeTienTien\Bai1_bank_loan\ketqua.txt", data)
